...
in curved spacetimes, specifically configured for Brill-Lindquist Initial Data.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Generate the Split-Pipeline Photon Geodesic Integrator (Brill-Lindquist)."
    )
    parser.add_argument(
        "--outdir",
        type=str,
    ...
    project_name = "photon_geodesic_batch_integrator_BL"
    exec_name = "photon_geodesic_batch_integrator_BL"
    ...
    SPACETIME = "BrillLindquist_Cartesian"
    PARTICLE = "photon"
    ...
    # Analytic Spacetime Parameters (Brill-Lindquist specific overrides)
    par.glb_code_params_dict["BH1_posn_x"].defaultvalue = 0.0
    par.glb_code_params_dict["BH1_posn_y"].defaultvalue = 0.0
    par.glb_code_params_dict["BH1_posn_z"].defaultvalue = 0.5
    par.glb_code_params_dict["BH1_mass"].defaultvalue = 0.5

    par.glb_code_params_dict["BH2_posn_x"].defaultvalue = 0.0
    par.glb_code_params_dict["BH2_posn_y"].defaultvalue = 0.0
    par.glb_code_params_dict["BH2_posn_z"].defaultvalue = -0.5
    par.glb_code_params_dict["BH2_mass"].defaultvalue = 0.5
