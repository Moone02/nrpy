...
// ----------------------------
typedef struct {
  double g4DD00, g4DD01, g4DD02, g4DD03, g4DD11, g4DD12, g4DD13, g4DD22, g4DD23, g4DD33;
} metric_struct;
// ----------------------------
// Basic definitions for module
// commondata_struct:
...
typedef struct __commondata_struct__ {
  REAL M_scale; // (nrpy.equations.general_relativity.geodesics.analytic_spacetimes)
  REAL a_spin;  // (nrpy.equations.general_relativity.geodesics.analytic_spacetimes)
